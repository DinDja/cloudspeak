...
export const EDUCATION_EVENT = {
  ...
  publicProfile: [
    'FEEBA, UNDIME, UNCME e CEE-BA',
    'Pró-Reitores das universidades estaduais e federais da Bahia e dos Institutos Federais (IFBA e IF Baiano)',
    'Gestores escolares e representantes de coordenação pedagógica',
    'CASA CIVIL, COJUVE, SDE, SEPROMI, SPM, SJDH, FAPESB, SETRE, SECULT, SEI, SEPLAN e SETUR',
  ],
  institutions: [
    'FEEBA',
    'UNDIME',
  ...
  guidedQuestions,
  program: [
    { time: '13h', theme: 'Abertura', institutions: 'SEC' },
    {
      time: '13h10',
    ...
    { time: '15h20', theme: 'Interação', institutions: 'instituições participantes' },
    {
      ...
      institutions: 'SETRE, IFBA e SESI',
    },
    { time: '15h50', theme: 'Interação', institutions: 'instituições participantes' },
    { time: '16h', theme: 'Leitura da carta', institutions: 'SEC' },
    { time: '16h10', theme: 'Encerramento', institutions: 'SEC' },
  ],
  schools: [
